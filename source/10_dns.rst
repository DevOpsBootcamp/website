...
How DNS servers store their information
(`rfc 1035 <http://tools.ietf.org/html/rfc1035>`_)
...
* CNAME
    * Like an alias: "Go look up the records of this other name"
* PTR
    * Pointer to a canonical name, returns name and stops processing
    * Used in reverse DNS
* SOA
